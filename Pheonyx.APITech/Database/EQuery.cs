...
namespace Pheonyx.APITech.Database
{
    ...
    public abstract class EQuery : ICollection
    {
        ...
        protected ICollection ItemCollection = null;
        protected QueryLock _lockManager;
        protected EQuery _parent;
        protected string PtrIndex = "";
        ...
        public string Path
        {
            get
            {
                return _parent == null
                    ? "$"
                    : _parent.Path + (_parent.Type == EQueryType.Array ? $"[{PtrIndex}]" : $".{PtrIndex}");
            }
            internal set { PtrIndex = value; }
        }
        ...
        public virtual int Count => ItemCollection.Count;
