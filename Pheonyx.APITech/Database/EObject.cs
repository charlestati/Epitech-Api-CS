...
namespace Pheonyx.APITech.Database
{
    ...
    public sealed class EObject : EQuery, IDictionary<string, EQuery>
    {
        ...
        {
            ItemCollection = new Dictionary<string, EQuery>();
            _instance = ItemCollection as Dictionary<string, EQuery>;
        }
        ...
        public override string ToString()
        {
            ...
            return
                $"\"{PtrIndex}\": {{ {_instance.Select(c => c.Value.ToString()).Aggregate((i, j) => i + ", " + j)} }}";
        }
