...
namespace Pheonyx.EpitechAPI
{
    public sealed class EpitechApi
    {
        ...
        public EpitechApi(HttpStatusCode[] ignoreStatusCode = null)
        {
        ...
        /// <param name="ignoreStatusCode">Tableau de <see cref="HttpStatusCode" /> à ignorer.</param>
        public EpitechApi(TimeSpan timeout, HttpStatusCode[] ignoreStatusCode = null)
        {
        ...
        /// <param name="ignoreStatusCode">Tableau de <see cref="HttpStatusCode" /> à ignorer.</param>
        public EpitechApi(string apiWebAgent, HttpStatusCode[] ignoreStatusCode = null)
        {
